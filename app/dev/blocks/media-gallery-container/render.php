...
$field      = get_field( 'wpbs_media_gallery' ) ?: get_field( 'wpbs_gallery' );
$field      = is_array( $field ) ? intval( $field[0] ?? false ) : intval( $field );
$gallery_id = $is_current ? $field : intval( $gallery_settings['gallery_id'] ) ?? $field;
