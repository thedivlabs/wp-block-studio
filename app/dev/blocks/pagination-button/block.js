...
function blockClassNames(attributes = {}, editor = false) {
    return [
        'wpbs-pagination-button inline-block w-fit min-h-10 py-1 px-4 relative z-20 cursor-pointer',
...
registerBlockType(metadata.name, {
    ...
    save: (props) => {
        ...
        return <button {...blockProps}>{props.attributes?.['wpbs-pagination-button']?.label ?? 'View More'}</button>;
