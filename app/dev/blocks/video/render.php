...
$button_class = implode( ' ', array_filter( [
	'wpbs-video__button pointer-events-none flex justify-center items-center absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 aspect-square z-20 transition-colors duration-300 leading-none text-white rounded-full opacity-50',
] ) );
