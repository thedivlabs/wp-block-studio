...
function parseBackgroundCSS(settings = {}) {
    ...
    if (settings['fade']) props['--fade'] = `linear-gradient(to bottom, rgba(0, 0, 0, 1) ${(settings['fade'] - 1)}%, rgba(0, 0, 0, 1) ${(settings['fade'])}%,rgba(0, 0, 0, 0) 100%)`;
    ...
    if (settings['fade-mobile']) bpProps['--fade'] = `linear-gradient(to bottom, rgba(0, 0, 0, 1) ${(settings['fade-mobile'] - 1)}%, rgba(0, 0, 0, 1) ${(settings['fade-mobile'])}%,rgba(0, 0, 0, 0) 100%)`;
