...
import {
    InspectorControls,
    useBlockProps, PanelColorSettings,
...
wp.hooks.addFilter(
    ...
    createHigherOrderComponent((BlockEdit) => {
        ...
        return (props) => {
            ...
            if (!props.name.includes('acf/divlabs')) {
                return (
                    <>
                    ...
                    <InspectorControls group="styles">
                        ...
                        <PanelColorSettings
                            ...
                            colorSettings={[
                                ...
                                return {
                                    value: props.attributes[color_control.slug],
                                    onChange: (color) => props.setAttributes({[color_control.slug]: color}),
