...
class WPBS {
	...
	public function theme_assets(): void {
		...
		wp_register_style( 'google-material-icons', 'https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200&display=block&icon_names=access_alarm,accessibility,account_balance,account_box,account_circle,add,add_a_photo,add_alarm,add_alert,add_box,add_circle,add_circle_outline,add_comment,add_location,add_photo_alternate,add_shopping_cart,add_task,add_to_drive,add_to_home_screen,add_to_photos,adjust,admin_panel_settings,air,airline_seat_flat,airline_seat_individual_suite,airplanemode_active,airplanemode_inactive,alarm,alarm_add,alarm_off,album,all_inbox,analytics,announcement,apartment,api,app_blocking,app_registration,approval,apps,arrow_back,arrow_forward,arrow_upward,arrow_downward,article,assessment,assignment,assistant,attach_file,attach_money,attachment,audio_file,autorenew,av_timer,backspace,backup,bar_chart,battery_alert,battery_charging_full,battery_full,battery_saver,bike_scooter,block,bluetooth,bluetooth_connected,bluetooth_disabled,bluetooth_searching,blur_circular,blur_linear,bolt,book,bookmark,bookmark_border,branding_watermark,brightness_1,brightness_2,brightness_4,brightness_5,brightness_6,brightness_7,bug_report,build,build_circle,bus_alert,cached,calendar_today,call,camera,camera_alt,camera_front,camera_rear,cancel,card_giftcard,card_membership,card_travel,casino,cast,check,check_box,check_circle,check_circle_outline,chrome_reader_mode,clear,close,cloud,cloud_done,cloud_download,cloud_off,cloud_queue,cloud_upload,code,collections,color_lens,colorize,comment,compare,computer,confirmation_number,contact_mail,contact_phone,contacts,content_copy,content_cut,content_paste,control_camera,copy,credit_card,dashboard,date_range,deck,delete,delete_forever,delete_outline,desktop_mac,desktop_windows,directions,directions_bike,directions_boat,directions_bus,directions_car,directions_railway,directions_run,directions_subway,directions_transit,directions_walk,disc_full,dns,done,done_all,donut_large,donut_small,drag_handle,drag_indicator,drive_eta,dvr,edit,edit_attributes,edit_location,edit_notifications,edit_off,eco,eject,email,emoji_emotions,emoji_events,emoji_flags,emoji_food_beverage,emoji_nature,emoji_objects,emoji_people,emoji_symbols,emoji_transportation,engineering,enhanced_encryption,equalizer,error,error_outline,escalator,escalator_warning,expand_less,expand_more,explore,explore_off,exposure,favorite,favorite_border,feedback,fiber_manual_record,fiber_new,fiber_pin,fiber_smart_record,filter_alt,filter_list,filter_list_alt,find_in_page,find_replace,fingerprint,fire_extinguisher,fitness_center,flag,flare,flash_auto,flash_off,flash_on,flight,flight_land,flight_takeoff,flip,flip_camera_android,flip_camera_ios,folder,folder_open,folder_shared,folder_special,follow_the_signs,food_bank,forest,fork_left,fork_right,format_align_center,format_align_justify,format_align_left,format_align_right,format_bold,format_clear,format_color_fill,format_color_reset,format_color_text,format_indent_decrease,format_indent_increase,format_italic,format_line_spacing,format_list_bulleted,format_list_numbered,format_list_numbered_rtl,format_paint,format_quote,format_shapes,format_size,format_strikethrough,format_textdirection_l_to_r,format_textdirection_r_to_l,format_underlined,forum,forward,forward_10,forward_30,forward_5,free_breakfast,fullscreen,fullscreen_exit,functions,g_translate,gavel,gif,garage,gas_meter,gesture,goat,google,grade,gradient,grading,grain,graphic_eq,grid_3x3,grid_4x4,grid_goldenratio,group,group_add,group_off,group_work,handyman,hardware,hd,hdr_off,hdr_on,hdr_strong,hdr_weak,headphones,healing,hearing,heart_broken,heat_pump,height,help,help_center,help_outline,high_quality,highlight,highlight_alt,highlight_off,history,history_edu,history_toggle_off,home,home_max,home_mini,home_work,horizontal_split,hospital,hotel,hourglass_bottom,hourglass_disabled,hourglass_empty,hourglass_full,house,house_siding,hvac,icecream,icon,images,image_aspect_ratio,import_contacts,import_export,important_devices,inline_chart,info,info_outline,input,insert_chart,insert_chart_outlined,insert_comment,insert_drive_file,insert_emoticon,insert_invitation,insert_link,insert_photo,insights,i', [], false );
