...
class WPBS {
	...
	public function theme_assets(): void {
		...
		if ( ! empty( $icon_names ) ) {
			...
			wp_register_style( 'google-material-icons-outlined', 'https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200&display=swap' . $icon_names, [], false );
